...
\begin{hslide}
\slsubsect{Flujo de llamadas del proyecto}
\begin{center}
\begin{figure}
...
\begin{hslide}
\slsubsect{Conexión local: getUserMedia}
\begin{center}
\begin{figure}
...
\begin{hslide}
\slsubsect{Conexión entre navegadores: Servidor de señalización}
\begin{itemize}
...
\begin{hslide}
\slsubsect{Conexión entre navegadores: Transmisión de vídeo con RTCPeerConnection}
\begin{itemize}
...
\begin{hslide}
\slsubsect{Conexión entre navegadores: Transmisión de datos con RTCDataChannel}
\begin{itemize}
...
\begin{hslide}
\slsubsect{Conexión entre navegadores: Interfaz web de usuario en cliente remoto}
\begin{center}
\begin{figure}
...
\begin{hslide}
\slsubsect{Experimento uno con drone real}
\begin{itemize}
...
\begin{hslide}
\slsubsect{Experimento dos con drone real}
\begin{itemize}
